...
function AddLinks() {
  ...
  return (
    <>
      <main className="flex md:gap-[24px] flex-1 relative ">
        <div className="hidden lg:flex bg-[#ffffff] min-w-[560px] h-auto pt-[101.5px] rounded-[12px] justify-center relative ">
        ...
        <div className=" bg-transparent w-[100%] flex flex-col items-center ">
          <div className="flex flex-col flex-1 w-[343px] md:w-[100%] rounded-t-[12px] p-[24px] md:p-[40px] bg-[#ffffff] ">
                ...
                {LinksHave.map((item, index) => {
                  ...
                  return (
                    <>
                      <div
                        key={index}
                        className="p-[20px] bg-[#fafafa] rounded-[12px] flex flex-col gap-[12px] "
                      >
          ...
          <div className=" w-[343px] md:w-[100%] p-[16px] border-t border-t-solid border-t-[#d9d9d9] bg-[#ffffff] rounded-b-[12px] md:px-[40px] md:py-[24px] md:flex md:justify-end ">
            <button
              className="rounded-[12px] bg-[#633cff] hover:opacity-50 w-[100%] md:w-auto flex justify-center py-[11px] md:px-[27px] "
              onClick={saveData}
            >
